...
public class MarketRetrofit_CCAddDemand extends MarketRetrofit_CCAddDemandSupplyBase {
    public MarketRetrofit_CCAddDemand(String name, float orderT, String addedT){
